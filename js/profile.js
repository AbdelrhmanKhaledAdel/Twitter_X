...
function getUsers() {
    ...
    .then((response) => {
        ...
        document.getElementById("profile-img").src = user.profile_image == "[object Object]" ? "image/avatar.png" : user.profile_image
        document.getElementById("number-user-img").src = user.profile_image == "[object Object]" ? "image/avatar.png" : user.profile_image
        ...
        //Posts & Comments
        document.getElementById("number-post").innerHTML = user.posts_count;
        document.getElementById("number-comment").innerHTML = user.comments_count;
        document.querySelector(".the-progress #posts").style.width = `${user.posts_count}%`;
        document.querySelector(".the-progress #comments").style.width = `${user.comments_count}%`;
    })
}
...
function getPosts() {
    ...
    .then((response) => {
        ...
        for(let post of posts) {
            ...
            <div class="head">
                <div class="user">
                    <div class="profile-photo" onclick="userClicked(${author.id}) style="cursor: pointer;"">
                        <img src="${author.profile_image == "[object Object]" ? "image/avatar.png" : author.profile_image}" alt="">
                    </div>
                <div class="ingo">
                    <h3 onclick="userClicked(${author.id})" style="cursor: pointer;">${author.username}</h3>
            ...
            <div class="photo">
                <img src="${post.image  == "[object Object]" ? "image/wallpaperflare.com_wallpaper (1).jpg" : post.image}" alt="">
            </div>
            <div class="like">
                <div class="love">
